...
const Points = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      ...
      if (status !== 'granted') {
        Alert.alert("Ops... :(", "Precisamos de sua localização para garantir a melhor experiência no app!")
        return;
      }
    ...
    <>
      <View style={styles.container}>
        ...
        <Text style = {styles.title}>
          <Icon name="smile" size={25} color="#fcba03"></Icon> Olá! Você está no Ecoleta!
        </Text>
